...
export const componentRegistry = [
	...
	},
	{
		...
		defaultData: {
			...
			bannerDescriptionColor: 'rgba(255, 255, 255, 0.85)',
			bannerDescriptionFontSize: '0.9rem',
			bannerDescriptionFontWeight: '400',
			bannerHeight: 'auto',
			bannerVisibilityMode: 'fixed',
			bannerDisplayDuration: 4000,
			bannerBorderColor: 'rgba(255, 255, 255, 0.35)',
			intervalMediaType: 'none',
			intervalImageUrl: '',
			intervalVideoUrl: '',
		...
		fields: [
			...
			{
				path: 'bannerDescription',
				label: 'Descrição da tarja',
				type: 'text',
				placeholder: 'Conteúdo complementar abaixo do título'
			},
			...
			{
				path: 'bannerFontWeight',
				label: 'Peso da fonte da tarja',
				type: 'text',
				placeholder: '600'
			},
			{
				path: 'bannerDescriptionColor',
				label: 'Descrição da tarja • cor',
				type: 'color'
			},
			{
				path: 'bannerDescriptionFontSize',
				label: 'Descrição da tarja • tamanho',
				type: 'text',
				placeholder: '0.9rem'
			},
			{
				path: 'bannerDescriptionFontWeight',
				label: 'Descrição da tarja • peso',
				type: 'text',
				placeholder: '400'
			},
			{ path: 'bannerHeight', label: 'Altura mínima da tarja', type: 'text', placeholder: 'auto' },
			{ path: 'bannerBorderColor', label: 'Cor da borda da tarja', type: 'color' },
			{
			...
			{
				path: 'backgroundMediaType',
				label: 'Mídia de fundo do player',
				type: 'select',
				options: [
			...
			{ path: 'backgroundImage', label: 'Imagem de fundo (JPG/PNG)', type: 'url' },
			{ path: 'backgroundVideo', label: 'Vídeo de fundo (MP4)', type: 'url' },
			{ path: 'backgroundVideoPoster', label: 'Poster do vídeo de fundo', type: 'url' },
