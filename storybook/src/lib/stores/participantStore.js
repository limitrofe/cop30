...
const sliderScrollResetStore = writable(0);
...
function resetGroupingState() {
	...
	triggerSliderScrollReset();
}

function triggerSliderScrollReset() {
	sliderScrollResetStore.update((value) => (Number.isFinite(value) ? value + 1 : 1));
}
...
export const sliderScrollResetSignal = derived(sliderScrollResetStore, ($value) =>
