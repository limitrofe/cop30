...
<script>
	...
	import ParticipantGallery from './story/ParticipantGallery.svelte';
	...
	function forwardOpenProfile(event) {
		dispatch('openProfile', event.detail);
	}
	...
	function getComponentType(paragraph) {
		...
		switch (type) {
			...
			case 'participant-gallery':
			case 'participants-gallery':
			case 'gallery-participants':
			case 'galeria-participantes':
				...
				<div class="story-section__inner" use:gsapAnimator={animationOptions}>
					...
					{:else if componentType === 'g1aovivo'}
						<G1AoVivo
							...
							bannerDescriptionColor={props.bannerDescriptionColor}
							bannerFontSize={props.bannerFontSize}
							bannerFontWeight={props.bannerFontWeight}
							bannerDescriptionFontSize={props.bannerDescriptionFontSize}
							bannerDescriptionFontWeight={props.bannerDescriptionFontWeight}
							...
							bannerBorderColor={props.bannerBorderColor}
							...
							backgroundMediaType={props.backgroundMediaType}
							backgroundImage={props.backgroundImage}
							backgroundVideo={props.backgroundVideo}
							backgroundVideoPoster={props.backgroundVideoPoster}
							title={props.title}
					...
					{:else if componentType === 'video-sheet-showcase'}
						<VideoSheetShowcase
							...
							chunkedSheet={props.chunkedSheet}
						/>
					...
					{:else if componentType === 'participant-highlight'}
						...
						<!-- 🌐 PARTICIPANT GALLERY -->
					{:else if componentType === 'participant-gallery'}
						<ParticipantGallery
							title={props.title}
							subtitle={props.subtitle || props.description}
							on:openProfile={forwardOpenProfile}
						/>
