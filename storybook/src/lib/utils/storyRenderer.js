	...
	return paragraphs.map((paragraph, index) => {
		...
		switch (type) {
			...
			case 'videosheets':
				...
				const hasInitialData = Boolean(paragraph.initialData);
				component.fetchOnMount =
					paragraph.fetchOnMount !== undefined ? paragraph.fetchOnMount !== false : !hasInitialData;
				component.initialData = paragraph.initialData;
				component.chunkedSheet = paragraph.chunkedSheet || null;
				break;
